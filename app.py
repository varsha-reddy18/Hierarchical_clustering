...
st.markdown("""
    <h1>🛍️ Mall Customer Hierarchical Clustering Prediction</h1>
""", unsafe_allow_html=True)
...
# =========================
    ...
    st.markdown("This dendrogram shows how clusters are formed at different levels.")

# Scale the data (same scaler used for prediction)
...
# Create dendrogram
    ...
    if st.button("🚀 Predict Cluster", use_container_width=True, key="predict_btn"):
        ...
        with col2_info:
            ...
            clustered_data = pd.read_csv("Cluster_hierarchical.csv")
        ...
        with viz_col1:
            ...
            clustered_df = pd.read_csv("Cluster_hierarchical.csv")
            ...
            fig = px.scatter_3d(
                ...
                color=clustered_df['clusters'].astype(str),
